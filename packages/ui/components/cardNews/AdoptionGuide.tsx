...
export default function AdoptionGuide() {
    ...
    useEffect(() => {
        let cancelled = false;
        getCardNewsByCategory(CATEGORY, { limitCount: LIST_LIMIT })
            .then((data) => {
    ...
    return (
        <section className="w-full">
            <div className="flex items-end justify-between gap-2">
                ...
                <Link
                    href={`/card_news?filter=${CATEGORY}`}
